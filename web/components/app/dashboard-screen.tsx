  ...
  return (
    <div className="space-y-6">
      <section className="border border-yz-neutral-300 bg-white">
        ...
        <div className="border-t border-yz-neutral-200 px-6 py-5 sm:px-8">
          ...
          {profile.completion.isComplete ? (
            ...
            <>
              ...
              <Link
                href="/profile"
                className="mt-5 inline-flex bg-yz-ink px-4 py-2.5 text-[13px] font-bold text-white transition-colors duration-150 hover:bg-yz-neutral-800"
              >
                Finish your profile
              </Link>
            </>
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        {ENTRY_POINTS.map((entry) => (
          <Link
            key={entry.href}
            href={entry.href}
            className="group border border-yz-neutral-300 bg-white p-6 transition-colors duration-150 hover:border-yz-ink"
          >
            <h2 className="font-brand text-[17px] font-extrabold tracking-tight text-yz-ink">
              {entry.title}
            </h2>
            ...
            <span className="mt-4 inline-block text-[12px] font-bold tracking-[0.08em] text-yz-ink uppercase underline-offset-4 group-hover:underline">
              Open
            </span>
          </Link>
        ))}

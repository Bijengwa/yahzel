...
export function ProfileSection({
  ...
  return (
    ...
    >
      <header className="flex flex-wrap items-start justify-between gap-3 border-b border-yz-neutral-200 px-5 py-3.5">
        <div>
          <h2 className="font-brand text-[15px] leading-tight font-extrabold tracking-tight text-yz-ink">
            {title}
          </h2>
      ...
      <div className="px-5 py-4">
        {status && (
          <p
            role="status"
            className={`mb-4 border px-3.5 py-2.5 text-[13px] ${
              status.tone === "ok"
        ...
        {editing && onSave && onCancel && (
          <div className="mt-5 flex flex-col-reverse gap-2 border-t border-yz-neutral-200 pt-4 sm:flex-row sm:items-center sm:justify-end">
